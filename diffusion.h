...
public:
    ...
    virtual void post_process_per_iteration(Eigen::MatrixXd &x);
...
class SetExpansionGraphSolver : public GraphSolver {
public:
    using GraphSolver::GraphSolver;
    void post_process_per_iteration(Eigen::MatrixXd &x) override;
};
